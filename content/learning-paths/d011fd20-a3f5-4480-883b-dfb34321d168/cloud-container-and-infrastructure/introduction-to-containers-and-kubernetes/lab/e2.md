...
1. Interact with a running container. This command starts up an ubuntu container and opens an
...
1. Let’s start an nginx web server and expose a port on the host to access the application. We will also
...
1. There are additional container run options; explore the sudo docker container --help command
